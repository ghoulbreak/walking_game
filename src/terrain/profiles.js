...
// Terrain profile system with different mountain range types

/**
 * Terrain profiles define parameters for different types of terrain
 */
...
/**
 * Get a terrain profile by name
 * @param {string} profileName - Name of the profile
 * @returns {Object} - The requested profile or the default profile
 */
...
/**
 * Blend between two profiles with a weight factor
 ...
 * @returns {Object} - A new profile with blended parameters
 */
